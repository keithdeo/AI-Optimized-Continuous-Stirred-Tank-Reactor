...
# -----------------------------------
# 2. Original reactor calculation process (UNOPTIMIZED)
# -----------------------------------
...
# Get value from user input for optimized conditions
...
print(
    f"AI Predicted Conversion: "
    f"{ai_prediction * 100:.4f}%"
)

print(
    f"Original Model Conversion: "
    f"{actual_conversion * 100:.4f}%"
)

print(
    f"Difference: "
    f"{conversion_difference:.4f} percentage points"
)
